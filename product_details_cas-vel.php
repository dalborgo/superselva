...
<div class="breadcrumb-section image-bg">
    ...
    <div class="breadcrumb-content">
        <div class="container text-center">
            <h1>CASSANI<span> VELOX</span></h1>
            <p>The products we create inspire us, reflect who we are as a society.</p><br>
            <a href="sotto_prodotti_cas.php" class="torna"><span
...
<div class="service-section section-padding">
    <div class="container">
     ...
     <!--<div class="service-tabs text-center">
        ...
        <?= elab('12', 'VELOX', 'cas-vel', 'uno', $uno,'Composto con un particolare tipo di legante che ci permette di stabilire il grado di durezza desiderata. La stabilità nel tempo permette di garantire, a qualsiasi clima, la sua particolare performance di SUPER-ABRASIVITA\'. Sono utilizzati per la lavorazione dei marmi. Disponibile in varie durezze. ','54',array(16,24,36,46,60,80,100,120,180,220,280,320)) ?>
        </div>
    </div><!-- container -->
</div><!-- service section -->
