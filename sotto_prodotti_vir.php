...
<div class="breadcrumb-section image-bg">
    ...
    <div class="breadcrumb-content">
        <div class="container text-center">
            <h1><span>VIRGOLE GENOVESI</span></h1>
    ...
    <div class="portfolio-content">
        <div class="text-center container listaPers">
            <ul class="portfoli-menu">
                ...
                <li><a href="#" data-filter=".vir-luc" class="">Virgole Veronesi Lucidanti</a></li>
                <li><a href="#" data-filter=".vir-res" class="">Virgole Veronesi Resina</a></li>
                <li><a href="#" data-filter=".vir-vel" class="">Virgole Veronesi Velox</a></li>
            </ul>
        </div>
        <div class="row portfolio-filter">
            <?= getSotto('5/EXTRA', 'LUCIDANTI','vir-luc','58') ?>
            <?= getSotto('SUPER-SINTETICO', 'RESINA','vir-res','30') ?>
            <?= getSotto('VELOX', 'VELOX','vir-vel','03') ?>
