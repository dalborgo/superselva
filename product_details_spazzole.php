    ...
    <div class="container">
        ...
        <div class="service-tabs text-center">
            <ul class="nav nav-tabs" role="tablist">
                <li role="presentation" class="<?= $uno ?>"><a href="#uno" data-toggle="tab">SPAZZOLA PER ANTICATO</a></li>
                <li role="presentation" class="<?= $due ?>"><a href="#due" data-toggle="tab">ACCIAIO TREFOLI</a></li>
            </ul>
        </div>

        <div class="tab-content service-content">
        <?= elab(13, 'SPAZZOLA PER ANTICATO', 'spazzole', 'uno', $uno,"Spazzole prodotte in varie forme e granulometrie per ottenere l’effetto ANTICATO su marmi e pietre naturali. ",'a richiesta', array(24,36,46,60,80,120,180,240,320,500)) ?>
        <?= elab(15, 'ACCIAIO TREFOLI', 'spazzole', 'due', $due,"Spazzole prodotte in varie forme e granulometrie per ottenere l’effetto ANTICATO su marmi e pietre naturali. ",'a richiesta', array('<abbr title="Acciaio Trefoli">A.TREFOLI</abbr>')) ?>
        </div>
    </div><!-- container -->
</div><!-- service section -->
