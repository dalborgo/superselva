...
<div class="breadcrumb-section image-bg">
    ...
    <div class="breadcrumb-content">
        <div class="container text-center">
            <h1>CASSANI<span> LUCIDANTI</span></h1>
...
<div class="service-section section-padding">
    <div class="container">
     ...
     <!--<div class="service-tabs text-center">
        ...
        <?=elab2('04', '5/EXTRA', 'cas-luc', 'uno', $uno,'Prodotto in varie forme e granulometrie. È utilizzato su marmi e pietre ','54','',array('PRESSATO'),array('SINTETICO'),'TIPO','') ?>
        </div>
    </div><!-- container -->
</div><!-- service section -->
