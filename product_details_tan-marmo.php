...
<div class="breadcrumb-section image-bg">
    ...
    <div class="breadcrumb-content">
        <div class="container text-center">
            <h1>TANGENZIALI<span> PER MARMO</span></h1>
...
<div class="service-section section-padding">
    <div class="container">
     ...
     <!-- <div class="service-tabs text-center">
        ...
        <?= elab2(65, 'LUCIDANTI "5 EXTRA" PER MARMO', 'tan-marmo', 'uno', $uno,'La nostra produzione ci permette di variare la durezza, senza alterare l’effetto lucidante, risolvendo le più ampie esigenze di lucidatura. ','24','',array('<span style="color:#F3CC29">N</span>','<span style="color:#F3CC29">Tipo</span>'),array('5 extra','normale'),'<span style="color:#F3CC29">TIPI</span>','') ?>
        </div>
    </div><!-- container -->
</div><!-- service section -->
