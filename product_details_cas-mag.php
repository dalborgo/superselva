...
<div class="breadcrumb-section image-bg">
    ...
    <div class="breadcrumb-content">
        <div class="container text-center">
            <h1>CASSANI<span> MAGNESITE</span></h1>
...
<div class="service-section section-padding">
    <div class="container">
     ...
     <!--<div class="service-tabs text-center">
        ...
        <?=elab('06', 'MAGNESITE', 'cas-mag', 'uno', $uno,'Prodotto in varie forme e granulometrie. È utilizzato su marmi e pietre ','56',array(16,24,36,46,60,80,100,120,180,220,280,320,400)) ?>
        </div>
    </div><!-- container -->
</div><!-- service section -->
