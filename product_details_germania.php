...
<div class="breadcrumb-section image-bg">
    ...
    <div class="breadcrumb-content">
        <div class="container text-center">
            <h1>FRANKFURT<span> GERMANIA</span></h1>
...
<div class="service-section section-padding">
    <div class="container">
        ...
        <?= elab(24, 'SINTETICO VELOX', 'germania', 'uno', $uno,"Composto con un particolare tipo di legante che ci permette di stabilire il grado di durezza desiderata. La stabilità nel tempo permette di garantire, a qualsiasi clima, la sua particolare performance di <strong>SUPER-ABRASIVITÀ</strong>. Sono utilizzati per la lavorazione dei marmi. Disponibile in varie durezze. ",20, array(16,24,36,46,60,80,100,120,180,220,280,320)) ?>
