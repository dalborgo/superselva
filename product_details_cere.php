    ...
    <div class="container">
     ...
     <div class="service-tabs text-center">
            <ul class="nav nav-tabs" role="tablist">
                <li role="presentation" class="<?= $uno ?>"><a href="#uno" data-toggle="tab">CERA LIQUIDA</a></li>
                <li role="presentation" class="<?= $due ?>"><a href="#due" data-toggle="tab">CERA SOLIDA</a></li>
            </ul>
        </div>

        <div class="tab-content service-content">
        <?=elab('31', 'CERA SOLIDA', 'cere', 'due', $due,'Per lucidare e ravvivare le superfici già lucide.','12',array(''),'') ?>
        <?=elab('33', 'CERA LIQUIDA', 'cere', 'uno', $uno,'Per lucidare e ravvivare le superfici già lucide.','12',array(''),'')?>
        </div>
    </div><!-- container -->
</div><!-- service section -->
