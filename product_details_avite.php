...
<div class="breadcrumb-section image-bg">
    ...
    <div class="breadcrumb-content">
        <div class="container text-center">
            <h1>RULLI<span> A VITE - DIAMETRO 100-120 MM</span></h1>
            <p>The products we create inspire us, reflect who we are as a society.</p><br>
            <a href="sotto_prodotti_rulli.php" class="torna"><span
...
<div class="service-section section-padding">
    <div class="container">
     ...
     <!--<div class="service-tabs text-center">
        ...
        <?=elab('80', 'VELOX', 'avite', 'uno', $uno,'Composto con un particolare tipo di legante che ci permette di stabilire il grado di durezza desiderata. La stabilità nel tempo permette di garantire, a qualsiasi clima, la sua particolare performance di SUPER-ABRASIVITÀ. Sono utilizzati per la lavorazione dei graniti, disponibile in varie durezze. ','20',array(
            16,24,36,46,60,80,100,120,180,220,320,360,400,600,800,1000)) ?>
        </div>
    </div><!-- container -->
</div><!-- service section -->
