...
<div class="breadcrumb-section image-bg">
    ...
    <div class="breadcrumb-content">
        <div class="container text-center">
            <h1>VIRGOLE GENOVESI<span> LUCIDANTI</span></h1>
...
<div class="service-section section-padding">
    <div class="container">
     ...
     <!--<div class="service-tabs text-center">
        ...
        <?= elab2('58', '5/EXTRA', 'vir-luc', 'uno', $uno,'La nostra produzione ci permette di variare la durezza, senza alterare l’effetto lucidante, soddisfando le più ampie esigenze di lucidatura.
','50','',array(
           'PRESSATO'),array('SINTETICO'),'TIPO','') ?>
        </div>
    </div><!-- container -->
</div><!-- service section -->
