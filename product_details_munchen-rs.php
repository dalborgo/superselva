...
<div class="breadcrumb-section image-bg">
    ...
    <div class="breadcrumb-content">
        <div class="container text-center">
            <h1>MÜNCHEN<span> RESINA</span></h1>
...
<div class="service-section section-padding">
    <div class="container">
     ...
     <!--<div class="service-tabs text-center">
        ...
        <?= elab('05', 'SUPER-SINTETICO', 'munchen-rs', 'uno', $uno,'Abrasivo di precisione a base di resine polyester.Questo tipo è inalterabile nel tempo ed è particolarmente indicato nelle operazioni di finissaggio delle superfici. Disponibile in varie durezze. ','50',array(
