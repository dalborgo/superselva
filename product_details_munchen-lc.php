...
<div class="service-section section-padding">
    <div class="container">
     ...
     <!--<div class="service-tabs text-center">
        ...
        <?= elab2('18', '5/EXTRA', 'munchen-lc', 'uno', $uno,'La nostra produzione ci permette di variare la durezza, senza alterare l’effetto lucidante, soddisfando le più ampie esigenze di lucidatura.
','50','',array(
