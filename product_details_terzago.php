...
<div class="breadcrumb-section image-bg">
    ...
    <div class="breadcrumb-content">
        <div class="container text-center">
            <h1>RULLI<span> TERZAGO - DIAMETRO 100-125-150MM</span></h1>
...
<div class="service-section section-padding">
    <div class="container">
     ...
     <!--<div class="service-tabs text-center">
        ...
        <?=elab('62', 'MAGNESITE PER GRANITO', 'terzago', 'uno', $uno,'Prodotto in varie forme e granulometrie. È utilizzato su marmi e pietre ','20',array(
